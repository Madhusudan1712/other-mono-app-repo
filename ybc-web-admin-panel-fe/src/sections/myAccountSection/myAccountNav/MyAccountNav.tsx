...
import type { MyAccountTabId } from '../MyAccountSection';

type MyAccountNavProps = {
  activeTab: MyAccountTabId;
  onChange: (tab: MyAccountTabId) => void;
};

const MyAccountNav: FC<MyAccountNavProps> = ({ activeTab, onChange }) => {
  return (
      ...
      <List disablePadding>
        ...
        >
          <BrandingWatermarkOutlinedIcon
            ...
            className={styles.leftNavIcon}
            sx={{
              color: activeTab === 'brand' ? 'warning.main' : 'text.primary'
            }}
          />
          <ListItemText
            primary="Brand"
